...
func (s *Server) initializeRoutes() {
	...
	s.Router.HandleFunc("/admin/{id}", middlewares.SetMiddlewareJSON(middlewares.SetMiddlewareAuthenticationAdmin(s.UpdateUser))).Methods("PUT")
	s.Router.HandleFunc("/admin/{id}", middlewares.SetMiddlewareAuthenticationAdmin(s.DeleteUser)).Methods("DELETE")
	...
	// s.Router.HandleFunc("/penyuluh", middlewares.SetMiddlewareJSON(middlewares.SetMiddlewareAuthenticationPenyuluh(s.GetPenyuluhs))).Methods("GET")
	s.Router.HandleFunc("/penyuluh/{id}", middlewares.SetMiddlewareJSON(s.GetUser)).Methods("GET")
	s.Router.HandleFunc("/penyuluh/{id}", middlewares.SetMiddlewareJSON(middlewares.SetMiddlewareAuthenticationPenyuluh(s.UpdateUser))).Methods("PUT")
	s.Router.HandleFunc("/penyuluh/{id}", middlewares.SetMiddlewareAuthenticationPenyuluh(s.DeleteUser)).Methods("DELETE")
	...
	// s.Router.HandleFunc("/majelis", middlewares.SetMiddlewareJSON(middlewares.SetMiddlewareAuthenticationPenyuluh(s.GetPenyuluhs))).Methods("GET")
	s.Router.HandleFunc("/majelis/{id}", middlewares.SetMiddlewareJSON(s.GetMajelis)).Methods("GET")
	s.Router.HandleFunc("/majelis/{id}", middlewares.SetMiddlewareJSON(middlewares.SetMiddlewareAuthenticationPenyuluh(s.UpdateUser))).Methods("PUT")
	s.Router.HandleFunc("/majelis/{id}", middlewares.SetMiddlewareAuthenticationPenyuluh(s.DeleteUser)).Methods("DELETE")
	...
	// s.Router.HandleFunc("/jadwal", middlewares.SetMiddlewareJSON(middlewares.SetMiddlewareAuthenticationPenyuluh(s.GetJadwals))).Methods("GET")
